...
class FieldContainer
{
    ...
    /**
     * 
     * @var \OrmBackend\Web\Fields\MetaField[]
     */
    protected $fields = [];
    
    /**
     *
     * @var \OrmBackend\Web\Fields\WrappedEntity[]
     */
    protected $entities = [];
     ...
     *
     * @param \OrmBackend\ORM\Entities\Entity[] $data
     */
    ...
    /**
     *
     * @return \OrmBackend\Web\Fields\WrappedEntity[]
     */
     ...
     *
     * @return \OrmBackend\Web\Fields\WrappedEntity|null
     */
    ...
    protected static function storeFile(UploadedFile $uploadedFile, string $targetEntity, string $inputName, string $type) : Entity
    {
        ...
        /**
         *
         * @var \OrmBackend\Types\FileType $targetEntity
         */
     ...
     *
     * @param \Doctrine\ORM\Mapping\ClassMetadata $classMetadata
     * @param \OrmBackend\ORM\Entities\Entity $instance
     * @param int $index
     * @return \OrmBackend\Web\Fields\MetaField[]
     */
