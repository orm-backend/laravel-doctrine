...
class Query
{
    ...
    /**
     * 
     * @var \OrmBackend\ORM\QueryValidator
     */
    protected $validator;
    
    /**
     * 
     * @var \OrmBackend\ORM\ParameterBuilder
     */
    protected $builder;
    ...
    protected function buildComparison(array $comparisonData)
    {
        ...
        if ($length == 1) {
            /**
             *
             * @var \OrmBackend\DBAL\DQLExpression $expression
             */
    ...
    /**
     * @param \OrmBackend\ORM\QueryValidator $validator
     */
    ...
    /**
     * @param \OrmBackend\ORM\ParameterBuilder $builder
     */
